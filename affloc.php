...
<html lang="en">
<head>
	<title>Affichage des locations ==>data base</title>
	<meta charset="UTF-8">
					...
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column3">Date de la Location</th>
								<th class="column4">N.de jours</th>
								<th class="column5">Prix par jour</th>
							</tr>
						</thead>
						<tbody>
								<?
