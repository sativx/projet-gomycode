...
$mat=$_POST['mat'];
$req="select c.ncin,c.nom,c.prenom,c.tel,loc.dateloc,loc.nbj,loc.pj
		from client c,voiture v,location loc
		where v.mat=loc.mat and c.ncin=loc.ncin and loc.mat='$mat';";
		...
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100">
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column4">Prénom</th>
								<th class="column5">Tel</th>
								<th class="column5">Date</th>
								<th class="column5">N.bj</th>
					...
					<?echo "<h1 style='color:tomato;'> Cette voiture nous a ganger = $somme dollar </h1>";   ?>
				</div>
			</div>
		</div>
	</div>
